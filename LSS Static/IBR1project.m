function P2 = IBR1project(mu,sigma)
...
% for index = 34:34
    %generate population
    pop = IBR1init_pop(pop_size,mu,sigma);

    temp1 = [];
    
    for iteration = 1:iteration_num
        %crossover
        children = IBR1crossover(pop,q0,mu,sigma);
        ...
        pop = IBR1select_parents(pop,children,mu,sigma);
...
P2_pop=[pop(1,1),pop(1,2),pop(1,3)];
P2=normcdf(-pop(1,3));
